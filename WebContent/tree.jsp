...
var treeMenu = [
	{ level:1, name:"加班管理"},
	{ level:2, name:"员工加班", ico:"images/icon_default.gif",link:"employeeWork/EmployeeWork_query.action"},
	{ level:2, name:"员工交通", ico:"images/icon_default.gif",link:"employeeTaxi/EmployeeTaxi_query.action"},
	{ level:1, name:"出差管理"},
	{ level:2, name:"员工出差", ico:"images/icon_default.gif",link:"employeeOut/EmployeeOut_query.action"},
	{ level:1, name:"调休管理"},
	{ level:2, name:"员工调休", ico:"images/icon_default.gif",link:"employeeRest/EmployeeRest_query.action"},
	{ level:1, name:"上级管理"},
	{ level:2, name:"交通补贴", ico:"images/icon_default.gif",link:"employeeTaxiSupply/EmployeeTaxiSupply_filter.jsp"},
	{ level:2, name:"餐补补贴", ico:"images/icon_default.gif",link:"employeeSupply/EmployeeSupply_query.action"},
